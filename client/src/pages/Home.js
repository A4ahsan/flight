                                                        ...
                                                        <div className="row">
                                                            <div className="col-sm-4 col-md-2">
                                                                <div ref={searchOneRef} className="select1_wrapper">
                                                                    ...
                                                                    <div className="input1_inner" style={{ display: "flex", alignItems: "center", cursor: "text" }} >
                                                                        <input required autoComplete='off'  onKeyDown={clearOnBackspace} onChange={handleChange} placeholder="Search City or Airport" value={valueFromSearch || value} className="input datepicker" style={{ width: "100%", outline: "none", border: "none" }} />
                                                            ...
                                                            <div className="col-sm-4 col-md-2">
                                                                <div ref={searchTwoRef} className="select1_wrapper">
                                                                    ...
                                                                    <div className="input1_inner" style={{ display: "flex", alignItems: "center", cursor: "text" }} >
                                                                        <input required autoComplete='off'  onKeyDown={clearOnBackspace2} onChange={handleChange2} placeholder="Search City or Airport" value={valueFromSearch2 || value2} className="input datepicker" style={{ width: "100%", outline: "none" }} />
                                                            ...
                                                            <div ref={dateRef} className="col-sm-4 col-md-2">
                                                                <div className="input1_wrapper">
                                                                    ...
                                                                    <div className="input1_inner" style={{ cursor: "pointer" }} onClick={() => showDatePicker === "depart" ? setShowDatePicker("false") : setShowDatePicker("depart")}>
                                                                        <input required readOnly style={{ caretColor: "transparent", cursor: "pointer" }} type="text" value={date[0].startDate ? format(date[0].startDate, "MM/dd/yyyy") : ""} className="input datepicker" placeholder="mm/dd/yyyy" />
                                                                    </div>
                                                            ...
                                                            <div ref={dateRef2} className="col-sm-4 col-md-2">
                                                                <div className="input1_wrapper">
                                                                    ...
                                                                    <div className="input1_inner" style={{ cursor: "pointer" }} onClick={() => showDatePicker === "return" ? setShowDatePicker("false") : setShowDatePicker("return")}>
                                                                        <input required readOnly style={{ caretColor: "transparent", cursor: "pointer" }} type="text" value={date[0].endDate ? format(date[0].endDate, "MM/dd/yyyy") : ""} className="input datepicker" placeholder="mm/dd/yyyy" />
                                                                    </div>
                                                                </div>
                                                            </div>
